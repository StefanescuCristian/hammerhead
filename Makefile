...
KERNELFLAGS	= -O3 -ffast-math -fforce-addr -fgcse-las -fgcse-sm -fgcse-after-reload -fgraphite-identity -floop-block -floop-interchange -floop-parallelize-all -floop-strip-mine -fmodulo-sched -fmodulo-sched-allow-regmoves -fsched-spec-load -fsingle-precision-constant -ftree-loop-distribution -ftree-loop-linear -ftree-parallelize-loops=4 -ftree-vectorize -fno-inline-functions -funroll-loops -ftree-loop-ivcanon -ftree-loop-im -fivopts -fsection-anchors -ftracer -fvect-cost-model=cheap -marm -mcpu=cortex-a15 -mfpu=neon-vfpv4 -mtune=cortex-a15 -munaligned-access -mvectorize-with-neon-quad -pipe
