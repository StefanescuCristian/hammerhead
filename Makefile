...
KERNELFLAGS	= -Ofast -DNDEBUG -fforce-addr -fgraphite-identity -floop-block -floop-interchange -floop-parallelize-all -floop-strip-mine -fmodulo-sched -fmodulo-sched-allow-regmoves -fsched-spec-load -fsingle-precision-constant -ftree-loop-distribution -ftree-loop-linear -ftree-parallelize-loops=4 -ftree-vectorize -fno-inline-functions -funroll-loops -fpeel-loops -floop-nest-optimize -funsafe-loop-optimizations -ftree-loop-ivcanon -ftree-loop-im -fivopts -fsection-anchors -ftracer -floop-flatten -fvect-cost-model=cheap -funit-at-a-time -fprefetch-loop-arrays -ffast-math -marm -mcpu=cortex-a15 -mfpu=neon-vfpv4 -mtune=cortex-a15 -munaligned-access -mvectorize-with-neon-quad -pipe
CC		+= $(KERNELFLAGS)
CPP		+= $(KERNELFLAGS)
