...
static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	...
	{ 1, {  499200, HFPLL, 2,  52 },  L2(2),  805000, 120 },
	{ 1, {  576000, HFPLL, 1,  30 },  L2(3),  815000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  825000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  835000, 180 },
	{ 1, {  806400, HFPLL, 1,  42 },  L2(4),  845000, 200 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  855000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  865000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  875000, 264 },
	{ 1, { 1113600, HFPLL, 1,  58 }, L2(10),  890000, 287 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  900000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  915000, 333 },
	{ 1, { 1344000, HFPLL, 1,  70 }, L2(14),  925000, 356 },
	{ 1, { 1420800, HFPLL, 1,  74 }, L2(15),  940000, 380 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  950000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  965000, 430 },
	{ 1, { 1651200, HFPLL, 1,  86 }, L2(17),  980000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  995000, 482 },
	{ 1, { 1804800, HFPLL, 1,  94 }, L2(18), 1010000, 510 },
	{ 1, { 1881600, HFPLL, 1,  98 }, L2(18), 1025000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19), 1040000, 565 },
	{ 1, { 2035200, HFPLL, 1, 106 }, L2(19), 1055000, 596 },
	{ 1, { 2112000, HFPLL, 1, 110 }, L2(19), 1070000, 627 },
	{ 1, { 2188800, HFPLL, 1, 114 }, L2(19), 1085000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1100000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs1[] __initdata = {
	...
	{ 1, {  345600, HFPLL, 2,  36 },  L2(1),  800000,  83 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  800000, 101 },
	{ 1, {  499200, HFPLL, 2,  52 },  L2(2),  800000, 120 },
	{ 1, {  576000, HFPLL, 1,  30 },  L2(3),  800000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  810000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  820000, 180 },
	{ 1, {  806400, HFPLL, 1,  42 },  L2(4),  830000, 200 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  840000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  850000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  860000, 264 },
	{ 1, { 1113600, HFPLL, 1,  58 }, L2(10),  875000, 287 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  885000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  895000, 333 },
	{ 1, { 1344000, HFPLL, 1,  70 }, L2(14),  910000, 356 },
	{ 1, { 1420800, HFPLL, 1,  74 }, L2(15),  920000, 380 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  930000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  945000, 430 },
	{ 1, { 1651200, HFPLL, 1,  86 }, L2(17),  960000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  975000, 482 },
	{ 1, { 1804800, HFPLL, 1,  94 }, L2(18),  990000, 510 },
	{ 1, { 1881600, HFPLL, 1,  98 }, L2(18), 1005000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19), 1020000, 565 },
	{ 1, { 2035200, HFPLL, 1, 106 }, L2(19), 1030000, 596 },
	{ 1, { 2112000, HFPLL, 1, 110 }, L2(19), 1045000, 627 },
	{ 1, { 2188800, HFPLL, 1, 114 }, L2(19), 1060000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1075000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
	...
	{ 1, {  499200, HFPLL, 2,  52 },  L2(2),  775000, 120 },
	{ 1, {  576000, HFPLL, 1,  30 },  L2(3),  785000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  795000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  805000, 180 },
	{ 1, {  806400, HFPLL, 1,  42 },  L2(4),  815000, 200 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  825000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  835000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  845000, 264 },
	{ 1, { 1113600, HFPLL, 1,  58 }, L2(10),  855000, 287 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  865000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  875000, 333 },
	{ 1, { 1344000, HFPLL, 1,  70 }, L2(14),  890000, 356 },
	{ 1, { 1420800, HFPLL, 1,  74 }, L2(15),  900000, 380 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  910000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  925000, 430 },
	{ 1, { 1651200, HFPLL, 1,  86 }, L2(17),  940000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  955000, 482 },
	{ 1, { 1804800, HFPLL, 1,  94 }, L2(18),  970000, 510 },
	{ 1, { 1881600, HFPLL, 1,  98 }, L2(18),  980000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19),  995000, 565 },
	{ 1, { 2035200, HFPLL, 1, 106 }, L2(19), 1005000, 596 },
	{ 1, { 2112000, HFPLL, 1, 110 }, L2(19), 1020000, 627 },
	{ 1, { 2188800, HFPLL, 1, 114 }, L2(19), 1035000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1050000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
	...
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  775000, 101 },
	{ 1, {  499200, HFPLL, 2,  52 },  L2(2),  775000, 120 },
	{ 1, {  576000, HFPLL, 1,  30 },  L2(3),  775000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  780000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  790000, 180 },
	{ 1, {  806400, HFPLL, 1,  42 },  L2(4),  800000, 200 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  810000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  820000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  830000, 264 },
	{ 1, { 1113600, HFPLL, 1,  58 }, L2(10),  840000, 287 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  850000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  860000, 333 },
	{ 1, { 1344000, HFPLL, 1,  70 }, L2(14),  875000, 356 },
	{ 1, { 1420800, HFPLL, 1,  74 }, L2(15),  885000, 380 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  895000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  910000, 430 },
	{ 1, { 1651200, HFPLL, 1,  86 }, L2(17),  925000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  935000, 482 },
	{ 1, { 1804800, HFPLL, 1,  94 }, L2(18),  950000, 510 },
	{ 1, { 1881600, HFPLL, 1,  98 }, L2(18),  960000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19),  970000, 565 },
	{ 1, { 2035200, HFPLL, 1, 106 }, L2(19),  985000, 596 },
	{ 1, { 2112000, HFPLL, 1, 110 }, L2(19),  995000, 627 },
	{ 1, { 2188800, HFPLL, 1, 114 }, L2(19), 1010000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1025000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs4[] __initdata = {
	...
	{ 1, {  806400, HFPLL, 1,  42 },  L2(4),  790000, 200 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  800000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  810000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  820000, 264 },
	{ 1, { 1113600, HFPLL, 1,  58 }, L2(10),  830000, 287 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  840000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  850000, 333 },
	{ 1, { 1344000, HFPLL, 1,  70 }, L2(14),  860000, 356 },
	{ 1, { 1420800, HFPLL, 1,  74 }, L2(15),  870000, 380 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  880000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  895000, 430 },
	{ 1, { 1651200, HFPLL, 1,  86 }, L2(17),  910000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  920000, 482 },
	{ 1, { 1804800, HFPLL, 1,  94 }, L2(18),  930000, 510 },
	{ 1, { 1881600, HFPLL, 1,  98 }, L2(18),  940000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19),  950000, 565 },
	{ 1, { 2035200, HFPLL, 1, 106 }, L2(19),  960000, 596 },
	{ 1, { 2112000, HFPLL, 1, 110 }, L2(19),  975000, 627 },
	{ 1, { 2188800, HFPLL, 1, 114 }, L2(19),  985000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1000000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	...
	{ 1, {  499200, HFPLL, 2,  52 },  L2(2),  750000, 120 },
	{ 1, {  576000, HFPLL, 1,  30 },  L2(3),  750000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  760000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  770000, 180 },
	{ 1, {  806400, HFPLL, 1,  42 },  L2(4),  780000, 200 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  790000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  800000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  810000, 264 },
	{ 1, { 1113600, HFPLL, 1,  58 }, L2(10),  820000, 287 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  830000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  840000, 333 },
	{ 1, { 1344000, HFPLL, 1,  70 }, L2(14),  850000, 356 },
	{ 1, { 1420800, HFPLL, 1,  74 }, L2(15),  860000, 380 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  870000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  880000, 430 },
	{ 1, { 1651200, HFPLL, 1,  86 }, L2(17),  890000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  900000, 482 },
	{ 1, { 1804800, HFPLL, 1,  94 }, L2(18),  910000, 510 },
	{ 1, { 1881600, HFPLL, 1,  98 }, L2(18),  920000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19),  930000, 565 },
	{ 1, { 2035200, HFPLL, 1, 106 }, L2(19),  940000, 596 },
	{ 1, { 2112000, HFPLL, 1, 110 }, L2(19),  955000, 627 },
	{ 1, { 2188800, HFPLL, 1, 114 }, L2(19),  965000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20),  975000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs6[] __initdata = {
	...
	{ 1, {  806400, HFPLL, 1,  42 },  L2(4),  770000, 200 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  780000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  790000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  800000, 264 },
	{ 1, { 1113600, HFPLL, 1,  58 }, L2(10),  810000, 287 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  820000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  830000, 333 },
	{ 1, { 1344000, HFPLL, 1,  70 }, L2(14),  840000, 356 },
	{ 1, { 1420800, HFPLL, 1,  74 }, L2(15),  850000, 380 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  860000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  870000, 430 },
	{ 1, { 1651200, HFPLL, 1,  86 }, L2(17),  875000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  885000, 482 },
	{ 1, { 1804800, HFPLL, 1,  94 }, L2(18),  895000, 510 },
	{ 1, { 1881600, HFPLL, 1,  98 }, L2(18),  905000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19),  915000, 565 },
	{ 1, { 2035200, HFPLL, 1, 106 }, L2(19),  920000, 596 },
	{ 1, { 2112000, HFPLL, 1, 110 }, L2(19),  930000, 627 },
	{ 1, { 2188800, HFPLL, 1, 114 }, L2(19),  940000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20),  950000, 691 },
	{ 0, { 0 } }
};
